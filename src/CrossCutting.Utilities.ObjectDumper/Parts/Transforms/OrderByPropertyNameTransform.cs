...
namespace CrossCutting.Utilities.ObjectDumper.Parts.Transforms
{
    public class OrderByPropertyNameTransform : IObjectDumperPartWithCallback
    {
        ...
        public OrderByPropertyNameTransform(string typeName) => _typeName = typeName;

        public OrderByPropertyNameTransform(Func<Type, bool> typeFilter) => _typeFilter = typeFilter;
