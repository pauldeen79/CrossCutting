...
public class StoredProcedureCommand<T>(string commandText,
        ...
        : DatabaseCommand<T>(commandText, DatabaseCommandType.StoredProcedure, instance, operation, commandParametersDelegate)
{
...
public class SqlStoredProcedureCommand(string commandText,
        ...
        : SqlDatabaseCommand(commandText, DatabaseCommandType.StoredProcedure, operation, commandParameters)
{
