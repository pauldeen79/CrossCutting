    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddPdcNet(this IServiceCollection instance)
        {
            return instance
                ...
                //query:
                .AddSingleton<IEntityFieldInfoProviderHandler, CatalogEntityFieldInfoProviderHandler>()
                ...
                //query:
                .AddSingleton<IEntityFieldInfoProviderHandler, ExtraFieldEntityFieldInfoProviderHandler>()
