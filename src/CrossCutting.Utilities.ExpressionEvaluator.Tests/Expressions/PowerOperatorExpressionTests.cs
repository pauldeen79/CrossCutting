...
public class PowerOperatorExpressionTests : TestBase
{
    public class ToBuilder : PowerOperatorExpressionTests
    {
        ...
        public void Returns_PowerOperatorEvaluatableBuilder_Correctly()
        {
            ...
            var sut = new PowerOperatorExpression(Result.Success<IExpression>(new OtherExpression(context, "4")), Result.Success<IExpression>(new OtherExpression(context, "2")), sourceExpression);
