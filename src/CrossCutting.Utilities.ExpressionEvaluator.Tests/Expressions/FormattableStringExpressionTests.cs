...
public class FormattableStringExpressionTests : TestBase<FormattableStringExpression>
{
    public class Evaluate : FormattableStringExpressionTests
    {
        [Theory]
        [InlineData("")]
    ...
    public class Parse : FormattableStringExpressionTests
    {
        [Theory]
        [InlineData("")]
        [InlineData("\"normal string \"")]
