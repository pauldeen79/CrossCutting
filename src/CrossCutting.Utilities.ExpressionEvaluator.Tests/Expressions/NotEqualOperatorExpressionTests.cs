...
public class NotEqualOperatorExpressionTests : TestBase
{
    public class ToBuilder : NotEqualOperatorExpressionTests
    {
        ...
        public void Returns_NotEqualOperatorEvaluatableBuilder_Correctly()
        {
            ...
            var sut = new NotEqualOperatorExpression(Result.Success<IExpression>(new OtherExpression(context, "Dummy1")), Result.Success<IExpression>(new OtherExpression(context, "Dummy2")), sourceExpression);
    ...
    public class EvaluateAsync : NotEqualOperatorExpressionTests
    {
        ...
        public async Task Returns_Correct_Result()
        {
            ...
            var context = CreateContext(sourceExpression);
            var sut = new NotEqualOperatorExpression(Result.Success<IExpression>(new OtherExpression(context, "true")), Result.Success<IExpression>(new OtherExpression(context, "true")), sourceExpression);
