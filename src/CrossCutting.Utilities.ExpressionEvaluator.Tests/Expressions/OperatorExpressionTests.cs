...
public class OperatorExpressionTests : TestBase
{
    ...
    public class EvaluateAsync : OperatorExpressionTests
    {
        [Fact]
        public async Task Returns_Error_From_Left_Expression()
        {
            ...
            var sut = new OperatorExpression(context, Result.Error<IExpression>("Kaboom"), ExpressionTokenType.Plus, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Error_From_Right_Expression()
        {
            ...
            var expression = "1 + 2";
            var context = CreateContext(expression);
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.Plus, Result.Error<IExpression>("Kaboom"), expression, BinaryComponents);
        ...
        public async Task Returns_Error_From_Left_Expression_Parsing()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.Plus, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Invalid_On_Unsupported_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.LeftParenthesis, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_Minus_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.Minus, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_Multiply_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.Multiply, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_Divide_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.Divide, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_Equal_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.Equal, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_NotEqual_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.NotEqual, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_Less_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.Less, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_LessOrEqual_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.LessOrEqual, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_Greater_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.Greater, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_GreaterOrEqual_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.GreaterOrEqual, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_Modulus_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.Modulus, Result.Success(Operator), expression, BinaryComponents);
        ...
        public async Task Returns_Success_On_Exponential_Operator()
        {
            ...
            var sut = new OperatorExpression(context, Result.Success(Operator), ExpressionTokenType.Exponentiation, Result.Success(Operator), expression, BinaryComponents);
    ...
    public class ParseAsync : OperatorExpressionTests
    {
        [Fact]
        public async Task Returns_Error_From_Left_Expression()
        {
