...
public class GreaterOrEqualOperatorExpressionTests : TestBase
{
    public class ToBuilder : GreaterOrEqualOperatorExpressionTests
    {
        ...
        public void Returns_GreaterOrEqualOperatorEvaluatableBuilder_Correctly()
        {
            ...
            var sut = new GreaterOrEqualOperatorExpression(Result.Success<IExpression>(new OtherExpression(context, "Dummy1")), Result.Success<IExpression>(new OtherExpression(context, "Dummy2")), sourceExpression);
            ...
            ((OtherExpression)GreaterOrEqualOperatorEvaluatableBuilder.LeftOperand).Expression.ShouldBe("Dummy1");
            GreaterOrEqualOperatorEvaluatableBuilder.RightOperand.ShouldBeOfType<OtherExpression>();
            ((OtherExpression)GreaterOrEqualOperatorEvaluatableBuilder.RightOperand).Expression.ShouldBe("Dummy2");
        }
    }
    ...
    public class EvaluateAsync : GreaterOrEqualOperatorExpressionTests
    {
        ...
        public async Task Returns_Correct_Result()
        {
            ...
            var context = CreateContext(sourceExpression);
            var sut = new GreaterOrEqualOperatorExpression(Result.Success<IExpression>(new OtherExpression(context, "2")), Result.Success<IExpression>(new OtherExpression(context, "1")), sourceExpression);
