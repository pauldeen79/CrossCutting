...
public class GreaterOrEqualOperatorExpressionTests : TestBase
{
    public class ToBuilder : GreaterOrEqualOperatorExpressionTests
    {
        ...
        public void Returns_GreaterOrEqualOperatorEvaluatableBuilder_Correctly()
        {
            ...
            var sut = new GreaterOrEqualOperatorExpression(Result.Success<IExpression>(new EvaluatableExpression("Dummy1")), Result.Success<IExpression>(new EvaluatableExpression("Dummy2")), sourceExpression);
    ...
    public class EvaluateAsync : GreaterOrEqualOperatorExpressionTests
    {
        ...
        public async Task Returns_Correct_Result()
        {
            ...
            var sut = new GreaterOrEqualOperatorExpression(Result.Success<IExpression>(new EvaluatableExpression("2")), Result.Success<IExpression>(new EvaluatableExpression("1")), sourceExpression);
    ...
    public class ToTypedBuilder : GreaterOrEqualOperatorExpressionTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
            // Arrange
            IEvaluatable<bool> sut = new GreaterOrEqualOperatorExpression(Result.Success<IExpression>(new EvaluatableExpression("true")), Result.Success<IExpression>(new EvaluatableExpression("true")), "source expression");
