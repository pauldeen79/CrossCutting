...
public class SubtractOperatorEvaluatableTests : TestBase
{
    public class EvaluateTypedAsync : SubtractOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
            // Arrange
            var sut = new SubtractOperatorEvaluatableBuilder()
    ...
    public class GetChildEvaluatables : SubtractOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
