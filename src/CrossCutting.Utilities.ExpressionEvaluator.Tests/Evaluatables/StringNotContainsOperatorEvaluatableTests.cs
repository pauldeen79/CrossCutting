...
public class StringNotContainsOperatorEvaluatableTests : TestBase
{
    public class EvaluateTypedAsync : StringNotContainsOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
            // Arrange
            var sut = new StringNotContainsOperatorEvaluatableBuilder()
    ...
    public class GetChildEvaluatables : StringNotContainsOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
