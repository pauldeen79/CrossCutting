...
public class NotEqualOperatorEvaluatableTests : TestBase
{
    public class EvaluateTypedAsync : NotEqualOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
            // Arrange
            var sut = new NotEqualOperatorEvaluatableBuilder()
    ...
    public class GetChildEvaluatables : NotEqualOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
    ...
    public class ToTypedBuilder : NotEqualOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
            // Arrange
            IEvaluatable<bool> sut = new NotEqualOperatorEvaluatableBuilder()
