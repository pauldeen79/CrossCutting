...
public class DivideOperatorEvaluatableTests : TestBase
{
    public class EvaluateTypedAsync : DivideOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
            // Arrange
            var sut = new DivideOperatorEvaluatableBuilder()
    ...
    public class GetChildEvaluatables : DivideOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
