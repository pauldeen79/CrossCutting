...
public class SmallerOperatorEvaluatableTests : TestBase
{
    public class EvaluateTypedAsync : SmallerOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
            // Arrange
            var sut = new SmallerOperatorEvaluatableBuilder()
    ...
    public class GetChildEvaluatables : SmallerOperatorEvaluatableTests
    {
        [Fact]
        public async Task Gives_Correct_Result()
        {
