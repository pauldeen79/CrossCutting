...
public class MidFunctionTests : TestBase<MidFunction>
{
    public class Evaluate : MidFunctionTests
    {
        ...
        {
            // Arrange
            var context = new FunctionCallContext(new FunctionCallBuilder().WithName("Mid").AddArguments("\"hello world\"", "1", "4"), CreateContext("Dummy"));
            var sut = CreateSut();
        ...
        {
            // Arrange
            var context = new FunctionCallContext(new FunctionCallBuilder().WithName("Mid").AddArguments("\"hello world\"", "0", "100000"), CreateContext("Dummy"));
            var sut = CreateSut();
        ...
        {
            // Arrange
            var context = new FunctionCallContext(new FunctionCallBuilder().WithName("Mid").AddArguments("\"hello world\"", "100000", "1"), CreateContext("Dummy"));
            var sut = CreateSut();
