...
public class CoalesceFunctionTests : TestBase<CoalesceFunction>
{
    public class Evaluate : CoalesceFunctionTests
    {
        ...
        {
            // Arrange
            var context = new FunctionCallContext(new FunctionCallBuilder().WithName("Coalesce").AddArguments("null", "null", "null"), CreateContext("Dummy"));
            var sut = CreateSut();
        ...
        {
            // Arrange
            var context = new FunctionCallContext(new FunctionCallBuilder().WithName("Coalesce").AddArguments("null", "null", "error"), CreateContext("Dummy"));
            var sut = CreateSut();
        ...
        {
            // Arrange
            var context = new FunctionCallContext(new FunctionCallBuilder().WithName("Coalesce").AddArguments("null", "null", "1"), CreateContext("Dummy"));
            var sut = CreateSut();
