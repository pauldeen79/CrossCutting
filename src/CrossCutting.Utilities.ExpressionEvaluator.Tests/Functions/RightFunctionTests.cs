...
public class RightFunctionTests : TestBase<RightFunction>
{
    public class Evaluate : RightFunctionTests
    {
        ...
        {
            // Arrange
            var context = new FunctionCallContext(new FunctionCallBuilder().WithName("Right").AddArguments("\"hello world\"", "5"), CreateContext("Dummy"));
            var sut = CreateSut();
        ...
        {
            // Arrange
            var context = new FunctionCallContext(new FunctionCallBuilder().WithName("Right").AddArguments("\"hello world\"", "100000"), CreateContext("Dummy"));
            var sut = CreateSut();
