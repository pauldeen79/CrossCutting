...
public class StringStartsWithOperatorEvaluatableHandlerTests : TestBase<StringStartsWithOperatorEvaluatableHandler>
{
    public class GetExpressionAsync : StringStartsWithOperatorEvaluatableHandlerTests
    {
        [Fact]
        public async Task Returns_SqlExpression_On_Right_Evaluatable()
        {
            ...
            var evaluatable = new StringStartsWithOperatorEvaluatableBuilder()
        ...
        public async Task Returns_SqlExpression_On_Right_Evaluatable_With_Inversion()
        {
            ...
            var evaluatable = new UnaryNegateOperatorEvaluatableBuilder()
                .WithOperand(
                        new StringStartsWithOperatorEvaluatableBuilder()
                            .WithLeftOperand(new LiteralEvaluatableBuilder("Test"))
                            .WithRightOperand(new LiteralEvaluatableBuilder("T")))
                .Build();
            var sut = CreateSut();
