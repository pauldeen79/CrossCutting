...
public class SmallerOperatorEvaluatableHandlerTests : TestBase<SmallerOperatorEvaluatableHandler>
{
    public class GetExpressionAsync : SmallerOperatorEvaluatableHandlerTests
    {
        [Fact]
        public async Task Returns_Correct_Sql()
        {
            ...
            var evaluatable = new SmallerOperatorEvaluatableBuilder()
        ...
        [Fact]
        public async Task Returns_Correct_Sql_With_UmaryNegateOperator()
        {
            // Arrange
            var parameterBag = new ParameterBag();
            var evaluatable = new UnaryNegateOperatorEvaluatableBuilder()
                .WithOperand(new SmallerOperatorEvaluatableBuilder()
                    .WithLeftOperand(new LiteralEvaluatableBuilder())
                    .WithRightOperand(new LiteralEvaluatableBuilder()))
                .Build();
            var sut = CreateSut();
