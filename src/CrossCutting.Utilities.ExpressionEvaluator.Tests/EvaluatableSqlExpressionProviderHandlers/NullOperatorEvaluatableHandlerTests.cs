...
public class NullOperatorEvaluatableHandlerTests : TestBase<NullOperatorEvaluatableHandler>
{
    public class GetExpressionAsync : NullOperatorEvaluatableHandlerTests
    {
        [Fact]
        public async Task Returns_Correct_Sql()
        {
            ...
            var evaluatable = new NullOperatorEvaluatableBuilder()
            ...
            result.Value.ShouldBe("@p0 IS NULL");
        }
    }
}