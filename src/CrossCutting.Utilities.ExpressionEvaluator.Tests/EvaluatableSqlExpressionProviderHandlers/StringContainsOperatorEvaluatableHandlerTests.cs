...
public class StringContainsOperatorEvaluatableHandlerTests : TestBase<StringContainsOperatorEvaluatableHandler>
{
    public class GetExpressionAsync : StringContainsOperatorEvaluatableHandlerTests
    {
        [Fact]
