...
public static class ExpressionStringEvaluatorExtensions
{
    ...
    public static Result Validate(this IExpressionStringEvaluator instance, string input, IFormatProvider formatProvider)
        => instance.Validate(input, formatProvider, null, null);

    public static Result Validate(this IExpressionStringEvaluator instance, string input, IFormatProvider formatProvider, IFormattableStringParser formattableStringParser)
        => instance.Validate(input, formatProvider, null, formattableStringParser);

    public static Result Validate(this IExpressionStringEvaluator instance, string input, IFormatProvider formatProvider, object? context)
