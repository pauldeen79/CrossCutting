...
{
    protected override Task<Result> GetConditionExpressionAsync(ConditionExpressionHandlerContext<StringNotEndsWithCondition> context, CancellationToken token)
