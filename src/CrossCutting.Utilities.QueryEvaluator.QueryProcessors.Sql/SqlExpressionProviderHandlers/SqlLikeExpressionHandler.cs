...
{
    protected override Result<string> DoGetSqlExpression(IQuery query, SqlLikeExpression expression, IQueryFieldInfo fieldInfo, ParameterBag parameterBag, ISqlExpressionProvider callback)
    {
        ...
        return callback.GetSqlExpression(query, expression.SourceExpression, fieldInfo, parameterBag)
