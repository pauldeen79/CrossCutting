...
{
    protected override Result<string> DoGetSqlExpression(IQuery query, DelegateExpression expression, IQueryFieldInfo fieldInfo, ParameterBag parameterBag, ISqlExpressionProvider callback)
    {
