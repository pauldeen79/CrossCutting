...
{
    protected override Result<string> DoGetSqlExpression(IQuery query, PropertyNameExpression expression, IQueryFieldInfo fieldInfo, ParameterBag parameterBag, ISqlExpressionProvider callback)
    {
