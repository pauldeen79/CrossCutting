...
{
    protected override Result<string> DoGetSqlExpression(IQuery query, LiteralExpression expression, IQueryFieldInfo fieldInfo, ParameterBag parameterBag, ISqlExpressionProvider callback)
    {
