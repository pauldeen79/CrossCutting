...
public sealed class DotExpressionDelegates<T>
{
    public DotExpressionDelegates(
        Func<DotExpressionComponentState, Result<Type>> parseDelegate,
        Func<DotExpressionComponentState, T, Result<object?>> evaluateDelegate)
    ...
    private DotExpressionDelegates(
        DotExpressionType expressionType,
        int argumentCount,
        Func<DotExpressionComponentState, Result<Type>> parseDelegate,
        Func<DotExpressionComponentState, T, Result<object?>> evaluateDelegate)
    {
