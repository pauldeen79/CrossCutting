...
public partial record GreaterOperatorEvaluatable : IChildEvaluatablesContainer
{
    ...
    public async Task<Result<bool>> EvaluateTypedAsync(ExpressionEvaluatorContext context, CancellationToken token)
        => (await new AsyncResultDictionaryBuilder()
            ...
            .OnSuccess(results => GreaterThan.Evaluate(results.GetValue(nameof(LeftOperand)), results.GetValue(nameof(RightOperand))));
