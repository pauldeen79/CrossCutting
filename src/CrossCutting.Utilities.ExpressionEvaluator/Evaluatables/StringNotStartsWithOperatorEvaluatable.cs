...
public partial record StringNotStartsWithOperatorEvaluatable : IChildEvaluatablesContainer
{
    ...
    public async Task<Result<bool>> EvaluateTypedAsync(ExpressionEvaluatorContext context, CancellationToken token)
        => (await new AsyncResultDictionaryBuilder()
            ...
            .OnSuccess(results => !results.GetValue<string>(nameof(LeftOperand)).StartsWith(results.GetValue<string>(nameof(RightOperand)), StringComparison));
