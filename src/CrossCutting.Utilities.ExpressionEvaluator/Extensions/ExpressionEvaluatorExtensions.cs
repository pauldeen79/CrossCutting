...
public static class ExpressionEvaluatorExtensions
{
    ...
    public static Task<ExpressionParseResult> ParseAsync(this IExpressionEvaluator instance, string expression, ExpressionEvaluatorSettings settings, IReadOnlyDictionary<string, Func<Task<Result<object?>>>>? state)
        => instance.ParseAsync(expression, settings, CancellationToken.None);

    public static Task<ExpressionParseResult> ParseAsync(this IExpressionEvaluator instance, string expression, ExpressionEvaluatorSettings settings, IReadOnlyDictionary<string, Func<Task<Result<object?>>>>? state, CancellationToken token)
    ...
    public static Task<Result<object?>> EvaluateAsync(this IExpressionEvaluator instance, string expression, ExpressionEvaluatorSettings settings, IReadOnlyDictionary<string, Func<Task<Result<object?>>>>? state, CancellationToken token)
        => instance.EvaluateAsync(new ExpressionEvaluatorContext(expression, settings, instance, state), token);

    public static Task<Result<object?>> EvaluateAsync(this IExpressionEvaluator instance, string expression, ExpressionEvaluatorSettings settings, IReadOnlyDictionary<string, Func<Task<Result<object?>>>>? state)
    ...
    public static Task<Result<T>> EvaluateTypedAsync<T>(this IExpressionEvaluator instance, string expression, ExpressionEvaluatorSettings settings, IReadOnlyDictionary<string, Func<Task<Result<object?>>>>? state, CancellationToken token)
        => instance.EvaluateTypedAsync<T>(new ExpressionEvaluatorContext(expression, settings, instance, state), token);

    public static Task<Result<T>> EvaluateTypedAsync<T>(this IExpressionEvaluator instance, string expression, ExpressionEvaluatorSettings settings, IReadOnlyDictionary<string, Func<Task<Result<object?>>>>? state)
