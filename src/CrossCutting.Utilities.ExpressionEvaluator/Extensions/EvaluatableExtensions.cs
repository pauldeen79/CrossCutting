...
public static class EvaluatableExtensions
{
    ...
    public static StringStartsWithOperatorEvaluatable StartsWith(this IEvaluatable instance, string value, StringComparison stringComparison = default)
        => new StringStartsWithOperatorEvaluatable(stringComparison, instance, new LiteralEvaluatable<string>(value));
    ...
    public static StringEndsWithOperatorEvaluatable EndsWith(this IEvaluatable instance, string value, StringComparison stringComparison = default)
        => new StringEndsWithOperatorEvaluatable(stringComparison, instance, new LiteralEvaluatable<string>(value));
    ...
    public static StringContainsOperatorEvaluatable Contains(this IEvaluatable instance, string value, StringComparison stringComparison = default)
        => new StringContainsOperatorEvaluatable(stringComparison, instance, new LiteralEvaluatable<string>(value));
    ...
    public static UnaryNegateOperatorEvaluatable DoesNotStartWith(this IEvaluatable instance, string value, StringComparison stringComparison = default)
        => new UnaryNegateOperatorEvaluatable(new StringStartsWithOperatorEvaluatable(stringComparison, instance, new LiteralEvaluatable<string>(value)));
    ...
    public static UnaryNegateOperatorEvaluatable DoesNotEndWith(this IEvaluatable instance, string value, StringComparison stringComparison = default)
        => new UnaryNegateOperatorEvaluatable(new StringEndsWithOperatorEvaluatable(stringComparison, instance, new LiteralEvaluatable<string>(value)));
    ...
    public static UnaryNegateOperatorEvaluatable DoesNotContain(this IEvaluatable instance, string value, StringComparison stringComparison = default)
        => new UnaryNegateOperatorEvaluatable(new StringContainsOperatorEvaluatable(stringComparison, instance, new LiteralEvaluatable<string>(value)));
}