...
{
    public ComposableEvaluatableExpressionBuilderWrapper(T instance, IEvaluatableBuilder leftExpression, Combination? combination = null) : base(instance, leftExpression, combination)
    {
    }
