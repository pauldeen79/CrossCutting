...
namespace CrossCutting.Utilities.QueryEvaluator.Core.Builders
{
    ...
    {
        private CrossCutting.Utilities.ExpressionEvaluator.Abstractions.IExpression _expression;
        ...
        public CrossCutting.Utilities.ExpressionEvaluator.Abstractions.IExpression Expression
        {
            ...
            set
            {
                bool hasChanged = !System.Collections.Generic.EqualityComparer<CrossCutting.Utilities.ExpressionEvaluator.Abstractions.IExpression>.Default.Equals(_expression!, value!);
        ...
        {
            _expression = default(CrossCutting.Utilities.ExpressionEvaluator.Abstractions.IExpression)!;
            SetDefaultValues();
        }

        public CrossCutting.Utilities.QueryEvaluator.Abstractions.ISortOrder Build()
        {
            return new CrossCutting.Utilities.QueryEvaluator.Core.SortOrder(Expression, Order);
        }
