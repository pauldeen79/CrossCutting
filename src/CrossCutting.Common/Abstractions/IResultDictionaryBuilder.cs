...
{
    IResultDictionaryBuilder Add(Func<IReadOnlyDictionary<string, Result>, Result> value);
    IResultDictionaryBuilder Add(Func<Result> value);
    IResultDictionaryBuilder Add(string name, Func<IReadOnlyDictionary<string, Result>, Result> value);
...
{
    IResultDictionaryBuilder<T> Add(Func<IReadOnlyDictionary<string, Result<T>>, Result<T>> value);
    IResultDictionaryBuilder<T> Add(Func<IReadOnlyDictionary<string, Result<T>>, Result> value);
    IResultDictionaryBuilder<T> Add(Func<Result<T>> value);
    IResultDictionaryBuilder<T> Add(Func<Result> value);
    IResultDictionaryBuilder<T> Add(string name, Func<IReadOnlyDictionary<string, Result<T>>, Result<T>> value);
    IResultDictionaryBuilder<T> Add(string name, Func<IReadOnlyDictionary<string, Result<T>>, Result> value);
