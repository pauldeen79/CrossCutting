...
public class StringNotContainsConditionTests : TestBase<StringNotContainsCondition>
{
    ...
    public class GetChildEvaluatables : StringNotContainsConditionTests
    {
        [Fact]
    ...
    public class ToTypedBuilder : StringNotContainsConditionTests
    {
        [Fact]
        public void Returns_Valid_Builder()
        {
            ...
            // Assert
            typedBuilder.ShouldBeOfType<StringNotContainsConditionBuilder>();
        }
    }
}
