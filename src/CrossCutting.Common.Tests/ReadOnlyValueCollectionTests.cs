...
public class ReadOnlyValueCollectionTests
{
    ...
    public void Can_Construct_Empty_ReadOnlyValueCollection_With_Custom_EqualityComparer()
    {
        ...
        // Act
        var actual = new ReadOnlyValueCollection<string>(equalityComparerMock);
    ...
    {
        // Act
        var actual = new ReadOnlyValueCollection<string>(["a", "b", "c"]);
    ...
    public void Can_Construct_Prefilled_ReadOnlyValueCollection_With_Custom_EqualityComparer()
    {
        ...
        // Act
        var actual = new ReadOnlyValueCollection<string>(["a", "b", "c"], equalityComparerMock);
    ...
    {
        // Arrange
        var value1 = new ReadOnlyValueCollection<string>(["a", "b", "c"]);
        var value2 = new ReadOnlyValueCollection<string>(["a", "b", "c"]);
    ...
    public void Can_Compare_Two_Different_ReadOnlyValueCollections_With_Default_EqualityComparer_1()
    {
        // Arrange
        var value1 = new ReadOnlyValueCollection<string>(["a", "b", "c"]);
        var value2 = new ReadOnlyValueCollection<string>(["a", "b"]);
    ...
    {
        // Arrange
        var value1 = new ReadOnlyValueCollection<string>(["a", "b"]);
        var value2 = new ReadOnlyValueCollection<string>(["a", "b", "c"]);
    ...
    public void Can_Compare_Two_ReadOnlyValueCollections_With_Custom_EqualityComparer()
    {
        ...
        equalityComparerMock.Equals(Arg.Any<string>(), Arg.Any<string>())
                            .Returns(x => x.ArgAt<string>(0).ToUpperInvariant() == x.ArgAt<string>(1).ToUpperInvariant());
        var value1 = new ReadOnlyValueCollection<string>(["a", "b", "C"], equalityComparerMock);
        var value2 = new ReadOnlyValueCollection<string>(["A", "b", "c"], equalityComparerMock);
    ...
    {
        // Arrange
        var value = new ReadOnlyValueCollection<string>(["a", "b", "C"]);
    ...
    {
        // Arrange
        var value = new ReadOnlyValueCollection<string?>([null, null]);
    ...
    {
        // Arrange
        var value = new ReadOnlyValueCollection<bool>([true, false]);
    ...
    {
        // Arrange
        var value = new ReadOnlyValueCollection<string>(["a", "b"]);
    ...
    {
        // Arrange
        var value = new ReadOnlyValueCollection<char>(['a', 'b']);
    ...
    {
        // Arrange
        var value = new ReadOnlyValueCollection<DateTime>([new DateTime(2020, 2, 1, 0, 0, 0, DateTimeKind.Unspecified)]);
