...
public class ValueCollectionTests
{
    ...
    {
        // Arrange
        var value1 = new ValueCollection<string>(["a", "b", "c"]);
        var value2 = new ValueCollection<string>(["a", "b", "c"]);
    ...
    public void Can_Compare_Two_Different_ValueCollections_With_Default_EqualityComparer_1()
    {
        // Arrange
        var value1 = new ValueCollection<string>(["a", "b", "c"]);
        var value2 = new ValueCollection<string>(["a", "b"]);
    ...
    {
        // Arrange
        var value1 = new ValueCollection<string>(["a", "b"]);
        var value2 = new ValueCollection<string>(["a", "b", "c"]);
    ...
    public void Can_Compare_Two_ValueCollections_With_Custom_EqualityComparer()
    {
        ...
        equalityComparerMock.Equals(Arg.Any<string>(), Arg.Any<string>())
                            .Returns(x => x.ArgAt<string>(0).ToUpperInvariant() == x.ArgAt<string>(1).ToUpperInvariant());
        var value1 = new ValueCollection<string>(["a", "b", "C"], equalityComparerMock);
        var value2 = new ValueCollection<string>(["A", "b", "c"], equalityComparerMock);
    ...
    {
        // Arrange
        var value = new ValueCollection<string>(["a", "b", "C"]);
    ...
    {
        // Arrange
        var value = new ValueCollection<string?>([null, null]);
    ...
    {
        // Arrange
        var value = new ValueCollection<bool>([true, false]);
    ...
    {
        // Arrange
        var value = new ValueCollection<string>(["a", "b"]);
    ...
    {
        // Arrange
        var value = new ValueCollection<char>(['a', 'b']);
    ...
    {
        // Arrange
        var value = new ValueCollection<DateTime>([new DateTime(2020, 2, 1, 0, 0, 0, DateTimeKind.Unspecified)]);
